...
- docker compose down -v - для удаления базы данных
- alembic revision --autogenerate -m "Initial migration" - скрипт для создания таблиц
- alembic upgrade head - накатить все миграции до последней(отправить бд)